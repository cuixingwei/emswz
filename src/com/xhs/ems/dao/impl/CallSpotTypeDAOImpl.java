...
import com.xhs.ems.bean.CallSpotType;
...
/**
 * @author 崔兴伟
 * @datetime 2015年4月15日 下午3:09:30
 */
@Repository
public class CallSpotTypeDAOImpl implements CallSpotTypeDAO {
	private static final Logger logger = Logger
			.getLogger(CallSpotTypeDAOImpl.class);
	 ...
	 * @author 崔兴伟
	 * @datetime 2015年4月15日 下午3:09:30
	 * @see com.xhs.ems.dao.CallSpotTypeDAO#getData(com.xhs.ems.bean.Parameter)
	 */
	@Override
	public Grid getData(Parameter parameter) {
		...
		List<CallSpotType> results = this.namedParameterJdbcTemplate.query(sql,
				paramMap, new RowMapper<CallSpotType>() {
					@Override
					public CallSpotType mapRow(ResultSet rs, int index)
							throws SQLException {

						return new CallSpotType(rs.getString("name"), rs
		...
		int totaltimes = 0;
		// 计算总终止次数
		for (CallSpotType result : results) {
