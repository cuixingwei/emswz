...
public class InStationTransforDetailDAOImpl implements
	...
	public Grid getData(Parameter parameter) {
		String sql = "select CONVERT(varchar(20),e.受理时刻,120) date,pc.姓名 patientName,pc.年龄 age,pc.性别 gender,"
				+ "pc.医生诊断 diagnose,pc.现场地点 outCallAddress,pc.科室 sendClass	from AuSp120.tb_EventV e "
				...
				+ "where e.事件性质编码=1 and t.分站编码 is not null and pc.任务编码 is not null and e.事件类型编码=3 and e.受理时刻 between :startTime and :endTime ";
