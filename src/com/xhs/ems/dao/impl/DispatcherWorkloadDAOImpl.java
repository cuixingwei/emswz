...
public class DispatcherWorkloadDAOImpl implements DispatcherWorkloadDAO {
	...
	public Grid getData(Parameter parameter) {
		String sql = "select m.姓名,COUNT(*) 电话总数,sum(case when tr.记录类型编码 in(1,2,3,5,8) then 1 else 0 end) 呼入,"
				...
				+ "left outer join AuSp120.tb_EventV e on e.事件编码=t.事件编码	left outer join AuSp120.tb_MrUser m on m.工号=a.调度员编码	"
				...
				+ "from #temp2 t2 group by t2.姓名   select t2.姓名,COUNT(*) 救治人数 into #temp4 from #temp2 t2	"
